...
// Model rows are intentionally absent here. The Tauri discovery pipeline is
// the only model catalog: the picker lists models returned by configured,
// successfully probed providers (plus Codex's native model/list result).
